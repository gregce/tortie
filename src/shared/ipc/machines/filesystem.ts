...
export interface RemoteDirListing {
   ...
   * their sentences live in src/renderer/machines/dir-picker.ts where the
...
// list is drawn by the renderer from src/renderer/machines/quick-open.ts, where
...
export interface MachinesFilesystemInvokeChannelMap {
  ...
  // src/renderer/machines/explorer.ts, where the vocabulary audit reads it.
  'machines:listFiles': {
