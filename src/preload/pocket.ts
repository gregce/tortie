/**
 * The door's half of the bridge (Phase 313): eight reads and presses that only
 * Settings then Phone reaches, and one subscription.
 *
 ...
 *
 * Three of them do change state — `removePhone`, `confirmDoor`, `forgetDoor` —
 * and that is not a contradiction of "no write route": they are a person
 * pressing a button in Tortie on this Mac, which is the only place the door's
 * agreement may be given or withdrawn.
 */
