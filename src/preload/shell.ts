 ...
 * can never deliver the same folder twice. All four are optional
 * feature-detected extras: an older preload means the Settings row does not
 * render and launches still work, since the slot and the argv acceptance
 * live in main.
 */
