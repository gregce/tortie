 ...
 * src/renderer/machines/scm.ts, and it draws the third as main sent it.
 ...
 * store is one. The three sentences are in src/renderer/machines/scm.ts.
 *
...
export interface RemoteChangesEntry {
   ...
   * src/renderer/machines/scm.ts and this store composes none.
   */
