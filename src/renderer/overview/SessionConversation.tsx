 ...
 *
 * Phase 147 moved the story of what a model wrote OUT of this view and onto
 * the project rows, where the written line itself lives. This view is the
 * real record and nothing on it is written by a model, so it offers no
 * model-written surface at all.
 */
