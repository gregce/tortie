...
- **Frame** (Phase 207, rebuilt in Phase 210), three controls and a strip.
  ...
  - **Shade**, a seven stop slider, where the ramp sits, from near black upward. **Depth**, a seven stop slider, how far the panels and hairlines stand apart. Both default to the shipped ramp and write nothing there.
