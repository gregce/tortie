...
- **Eleven agents supported out of the box.** Claude Code, Codex, Cursor, Gemini, Qwen, Muse, Pi, CodeWhale, Antigravity, Droid, Muse and plain shells, each with its own icon, settable hotkey and launch flags.
